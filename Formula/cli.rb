class Cli < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm?
      url "https://dl.ryannz.com/download/cli/v0.1.3/cli-aarch64-apple-darwin.tar.xz"
      sha256 "6a079fbbe4833fa3750656a942c591bd95760aba77221e264fdbae4bdb035608"
    end
    if Hardware::CPU.intel?
      url "https://dl.ryannz.com/download/cli/v0.1.3/cli-x86_64-apple-darwin.tar.xz"
      sha256 "ca4006c322af89c8c32143d8d1e1c2cf460c19a67ba8c97f2f76afc07d00d96f"
    end
  end
  if OS.linux?
    if Hardware::CPU.arm?
      url "https://dl.ryannz.com/download/cli/v0.1.3/cli-aarch64-unknown-linux-gnu.tar.xz"
      sha256 "7b68556a855047c1763caf25576cce551ce0b2615902fdfca4e53155c7612d01"
    end
    if Hardware::CPU.intel?
      url "https://dl.ryannz.com/download/cli/v0.1.3/cli-x86_64-unknown-linux-gnu.tar.xz"
